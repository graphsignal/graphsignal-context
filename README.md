...
Install the Graphsignal skill so your AI coding agent can run `graphsignal-context fetch` for a time range and use the returned context (profiles, errors, traces) to help you debug.
